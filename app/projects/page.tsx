          ...
          <Card className="bg-zinc-800 border-zinc-700">
            ...
            <CardContent>
              ...
              <ul className="list-disc list-inside text-zinc-400 space-y-2">
                <li>
                  Created over 300 precise engineering drawings and assemblies in SolidWorks and AutoCAD, using
                  SolidWorks PDM and SAP while following strict ECR and GD&T standards.
                </li>
                <li>
                ...
                <li>
                  Developed a solid understanding of weldments, sheet metal fabrication, and material selection,
                  applying adaptability and a continuous learning mindset to real-world manufacturing challenges.
                </li>
              </ul>
            </CardContent>
          </Card>
